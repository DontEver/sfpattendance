...
def repeat():
    ...
    email_phone.send_keys(email_element)
    time.sleep(3)
    ...
    password.send_keys(password_element)
    time.sleep(3)
    ...
    driver.find_element_by_xpath(
        "//ol//div[contains(text(),'SFP Attendance')]").click()
    time.sleep(3)
    print('Going to attandance tab')
    driver.find_element_by_xpath(
        "//html//body//div//div//div//aside//div//div//div//div//div//a[contains(text(),'Attendance')]").click()
    time.sleep(2)
    print('Turning in attendance!')
    driver.find_element_by_xpath(
        "/html/body/div[4]/div/div/div[2]/aside/div[1]/div[2]/div[2]/span/label[1]/span").click()
    time.sleep(2)
    driver.find_element_by_xpath(
        "/html/body/div[4]/div/div/div[2]/aside/div[1]/div[2]/div[3]/div/span").click()
    time.sleep(1)
    driver.find_element_by_xpath(
        "/html/body/div[12]/div/div[2]/div[3]/div[2]/span/span").click()
